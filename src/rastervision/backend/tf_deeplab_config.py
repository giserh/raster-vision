...
class TFDeeplabConfigBuilder(BackendConfigBuilder):
    ...
    def _process_task(self):
        return self.with_config(
            {
                'train_crop_size': [self.task.chip_size, self.task.chip_size]
            },
    ...
    def with_template(self, template):
        ...
        from rastervision.protos.deep_lab.train_pb2 import (
    ...
    def with_batch_size(self, batch_size):
        return self.with_config({'train_batch_size': batch_size})

    def with_num_steps(self, num_steps):
        return self.with_config({'training_number_of_steps': num_steps})
    ...
    def with_train_options(self, train_restart_dir=None, sync_interval=600):
        ...
        return b.with_config({
            'save_interval_secs': sync_interval,
            'save_summaries_secs': sync_interval
        })
    ...
    def with_script_locations(self,
        ...
        script_locs = TFDeeplabConfig.ScriptLocations(
            train_uri=train_uri, export_uri=export_uri)
        b = deepcopy(self)
